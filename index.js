...
findBreweryForm.addEventListener('submit', (e) => {
  ...
  searchResult
    .then((foundBreweries) => foundBreweries.forEach((brewery) => showBrewery(brewery)));
});
